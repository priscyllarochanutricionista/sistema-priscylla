        ...
        formFiltro.addEventListener('submit', async (e) => {
            ...
            try {
                if(tipoRelatorio === 'faturamento' || tipoRelatorio === 'receitas' || tipoRelatorio === 'despesas') {
                    ...
                    tbody.innerHTML = `<tr><td><strong>Faturamento Bruto</strong></td><td class="text-success">${formatarMoeda(totRec)}</td></tr><tr><td><strong>Custos / Despesas</strong></td><td class="text-danger">${formatarMoeda(totDes)}</td></tr><tr style="background-color: #f8fafc;"><td><strong>LUCRO LÍQUIDO</strong></td><td style="font-weight:bold;">${formatarMoeda(totRec - totDes)}</td></tr><tr><td>Total de Consultas Marcadas</td><td>${agendados}</td></tr><tr><td>Consultas Realizadas (Conversão)</td><td class="text-success">${realizados} (${agendados > 0 ? Math.round((realizados/agendados)*100) : 0}%)</td></tr><tr><td>Novos Pacientes (Consulta)</td><td class="text-primary">${prim}</td></tr><tr><td>Retornos</td><td>${ret}</td></tr>`;
