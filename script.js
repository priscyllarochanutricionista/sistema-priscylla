document.addEventListener('DOMContentLoaded', () => {
    ...
    const telas = {
        ...
        'relatorios': document.getElementById('tela-relatorios') // Atualizado para a Central
    };
    ...
    if(formFiltro) {
        formFiltro.addEventListener('submit', async (e) => {
            ...
            try {
                // 4.1 RELATÓRIOS FINANCEIROS (Faturamento, Receitas, Despesas)
    ...
    // Geração Inteligente do PDF (Pega o Título Dinâmico do Select)
